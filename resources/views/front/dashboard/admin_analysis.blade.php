                    ...
                    <?php $active_tab =  base64_decode(Request::segment(4)) ?>
                        <div class="clever-tabs-content">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link1 <?php if($active_tab==0) echo "active"; ?>" href="{{ url('admin_analysis').'/'.Request::segment(2).'/'.Request::segment(3).'/'.base64_encode(0)}}" ><small>Summary</small> <br> Test Overview</a>
                                </li>
                                @if($sections)
                                    ...
                                    <?php 
                                     ...
                                     ?> 
                                        <li class="nav-item">
                                            <a class="nav-link1 <?php if($active_tab==$row->id) echo "active"; ?>" id="tab--{{$row->id}}" href="{{ url('admin_analysis').'/'.Request::segment(2).'/'.Request::segment(3).'/'.base64_encode($row->id)}}" >
                                                @if($section_status==2)
