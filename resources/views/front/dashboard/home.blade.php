                                        ...
                                        <div class="clever-faqs">
                                            ...
                                            <div class="accordions" id="accordion" role="tablist" aria-multiselectable="true">
                                                ...
                                                <div class="panel single-accordion">
                                                    ...
                                                    <h6><a role="button" class="collapsed" aria-controls="collapse{{$sn}}" data-toggle="collapse" data-parent="#accordion" href="#collapse{{$sn}}">
                                                        {{ $rows->test_name }}
                                                    <span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                                    <span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                                    </a></h6>                                                    
                                                    <div id="collapse{{$sn}}" class="accordion-content collapse">
                                                                                    ...
                                                                                    <div class="col-md-4 col-sm-12">
                                                                                        <div class="register-login-area">
                                                                                          ...
                                                                                          { ?>
                                                                                            ...
                                                                                            <?php } else { ?>
                                                                                                 <a href="{{ url('analysis/'.base64_encode($user_id).'/'.base64_encode($rows->id).'/'.base64_encode(0))}}" class="btn" style="text-transform: capitalize !important;"> <i class="fa fa-bar-chart" aria-hidden="true"></i>View Results</a>
                                                                                                <?php } ?>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
