          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title">Assign Section Questions</h5>
                <ol class="breadcrumbs">
                  <li><a href="{{ url('home')}}">Dashboard</a></li>
                  <li><a href="{{ url('assign_section')}}">Assign Section Questions</a></li>
                </ol>
              </div>
            </div>
          </div>
            ...
            <div id="work-collections">
              ...
              <div class="col s12 m12 l12">
                <div class="card-panel">
                  <div class="row">
                    <form class="col s12"  method="post" action="{{url('add_section_questions')}}">
                       {{ csrf_field() }}
            ...
            <div id="work-collections">
              <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                      <div class="row">
                         <h4 class="header2">Please Select Questions</h4>
                         <div class="row">
                             <div class="input-field col s4">
...
<script type="text/javascript">
  ...
  function get_selected_question(sender)
  {
    ...
    {
      if(question_ids_list.indexOf($(sender).attr("data_id"))=="-1")
      {
        question_lists.push('<span data_id="'+$(sender).attr("data_id")+'">- ' + $(sender).attr("data_value") + '&nbsp;<i class="material-icons task-cat red accent-2" style="cursor:pointer;" onClick="unselectQuestion(this)" title="Remove Question">clear</i></span>');
        question_ids_list.push($(sender).attr("data_id"));
  ...
  {
    question_lists.splice(question_ids_list.indexOf($(sender).parent().attr("data_id")),1);
    question_ids_list.splice(question_ids_list.indexOf($(sender).parent().attr("data_id")),1);
    if(typeof('input:checkbox[value="'+$(sender).parent().attr("data_id")+'"]') != 'undefined')
    {
        $('input:checkbox[value="'+$(sender).parent().attr("data_id")+'"]').prop('checked', false);      
    }
    var list = question_lists.join("<br/>  ");
      var id_list = question_ids_list.join(",");
      $("#selected_questions").html(list);
