                                    ...
                                    <div class="clever-description">
                                        ...
                                        <div class="clever-faqs">
                                           ...
                                           <div style="border-top: 1px solid #eeeeee;padding: 20px;">
                                                <!-- <a href="<?php echo e(url('end/'.Request::segment(2).'/'.Request::segment(3))); ?>" class="btn clever-btn" style="width: 300px;background: #e41515;">End & Score</a> -->
...
<script type="text/javascript">
    ...
    function end()
    {
        ...
        var url = "<?php echo e(url('end/'.Request::segment(2).'/'.Request::segment(3))); ?>";
        window.location.replace(url);
    }
</script>

<?php echo $__env->make('front.layout.dashboard_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\training\admin\resources\views/front/dashboard/end_section.blade.php ENDPATH**/ ?>