                    ...
                    <?php $active_tab =  base64_decode(Request::segment(4)) ?>
                        <div class="clever-tabs-content">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link1 <?php if($active_tab==0) echo "active"; ?>" href="<?php echo e(url('admin_analysis').'/'.Request::segment(2).'/'.Request::segment(3).'/'.base64_encode(0)); ?>" ><small>Summary</small> <br> Test Overview</a>
                                </li>
                                <?php if($sections): ?>
                                    ...
                                    <?php 
                                     ...
                                     ?> 
                                        <li class="nav-item">
                                            <a class="nav-link1 <?php if($active_tab==$row->id) echo "active"; ?>" id="tab--<?php echo e($row->id); ?>" href="<?php echo e(url('admin_analysis').'/'.Request::segment(2).'/'.Request::segment(3).'/'.base64_encode($row->id)); ?>" >
...
<?php echo $__env->make('front.layout.dashboard_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\training\admin\resources\views/front/dashboard/admin_analysis.blade.php ENDPATH**/ ?>