                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-6">
                        ...
                        <p><ul>
                                ...
                                <li>
                                    <ul class="dropdown">
                                        <li><a href="<?php echo e(url('dashboard')); ?>" style="color:#999987;font-size:13px;font-weight:400;">Dashboard</a></li>
                                        <li><a href="<?php echo e(url('logout_user')); ?>" style="color:#999987;font-size:13px;font-weight:400;">Logout</a></li>
                                    </ul>
                                </li>
                                <?php else: ?>
                                    <li><a href="<?php echo e(url('login_user')); ?>" style="color:#999987;font-size:13px;font-weight:400;">Login</a></li>
                                <?php endif; ?>
                            </ul></p>
                    </div>
                    <div class="col-md-2 col-sm-2 col-xs-6">
    ...
    <!-- ##### Footer Area End ##### --><?php /**PATH C:\xampp\htdocs\training\admin\resources\views/front/layout/footer.blade.php ENDPATH**/ ?>