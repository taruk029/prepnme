              ...
              <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                      <div class="row">
                        <form class="col s12" method="post" action="<?php echo e(url('add_bulk_test')); ?>" id="bulk_form" enctype="multipart/form-data">
                            ...
                            <div class="input-field col s12">
                                <select name="test" id="test" required="required" onchange="javascript:get_test()">
                                  ...
                                  <?php $__currentLoopData = $tests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($row->id); ?>"><?php echo e($row->test_name); ?></option>
                          ...
                          <div class="row" id="test_name_id" style="display: none;">
                            <div class="input-field col s12">
                              <input id="test_name" type="text" name="test_name" value="<?php echo e(old('test_name')); ?>" >
      ...
      <div class="row">
        <h5 class="breadcrumbs-title">Add Section</h5>
                        <form class="col s12" method="post" id = "form_id">
                          ...
                          <div class="row">
                            <div class="input-field col s6">
                              <input id="duration_in_mins" type="text" name="Duration in mins" onkeypress="return NumbersOnly(event,this)" maxlength="3" required="required" value="<?php echo e(old('duration_in_mins')); ?>">
                            ...
                            <div class="input-field col s6">
                              <input id="description" type="text" name="description" value="<?php echo e(old('description')); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\training\admin\resources\views/tests/bulk_upload.blade.php ENDPATH**/ ?>