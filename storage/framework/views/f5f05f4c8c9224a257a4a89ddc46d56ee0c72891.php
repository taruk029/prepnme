          ...
          <div class="container">
            <div class="row">
              <div class="col s10 m6 l6">
                <h5 class="breadcrumbs-title">Assign Section</h5>
                <ol class="breadcrumbs">
                  <li><a href="<?php echo e(url('home')); ?>">Dashboard</a></li>
                  <li><a href="<?php echo e(url('assign_section')); ?>">Assign Section</a></li>
                </ol>
              </div>
            </div>
          </div>
              ...
              <div class="row">
                <div class="col s12 m12 l12">
                    <div class="card-panel">
                      <div class="row">
                        <form class="col s12" method="post" action="<?php echo e(url('assign_section')); ?>">
                          ...
                          <div class="row">
                            ...
                            <div class="col s6 m3">
                              <label class="container_label_check"><?php echo e($row->section); ?>

                                  <input type="checkbox" name="section[]" value="<?php echo e($row->id); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\training\admin\resources\views/test_sections/add.blade.php ENDPATH**/ ?>